...
public class UserController {
	...
	public ResponseEntity<Object> getUser(Authentication authentication) {		
		try {
	        ...
	        ArrayList<UserDetails> listUserRet = new ArrayList<UserDetails>();
	        for (User rowUser : listUser) {
	        	UserDetails userDet = new UserDetails();
	        	userDet.setUsername(rowUser.getUsername());
	        	userDet.setRole(rowUser.getRole());
	        	listUserRet.add(userDet);
	        }
