...
@Entity
@Table(name="down_tilt")
public class DownTilt {
	...
	public DownTilt(@NotEmpty(message = "name is mandatory") String name,
	...
	public String toString() {
		return "DownTilt [id=" + id + ", name=" + name + ", damage=" + damage + ", frame=" + frame + ", endlag=" + endlag
				+ ", character=" + character + "]";
	}
}
