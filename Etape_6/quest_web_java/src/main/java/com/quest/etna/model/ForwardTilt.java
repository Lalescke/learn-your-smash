...
@Entity
@Table(name="forward_tilt")
public class ForwardTilt {
	...
	public ForwardTilt(@NotEmpty(message = "name is mandatory") String name,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ForwardTilt other = (ForwardTilt) obj;
	...
	public String toString() {
		return "ForwardTilt [id=" + id + ", name=" + name + ", damage=" + damage + ", frame=" + frame + ", endlag=" + endlag
				+ ", character=" + character + "]";
	}
}
